...
const References = () => {
    ...
    return (
        <section id="references" className="border-b border-gray-400 p-5 mt-5">
            <h1 style={{fontFamily:'roboto'}} className="text-3xl lg:text-5xl font-bold text-center">NOS RÉFÉRENCES</h1>
